...
- **Reduce provision polling delay**: The fixed 5-minute `ContinueAction` interval adds unnecessary latency. Options: Tower job callback (eliminates polling) or adaptive polling (start at 30s, backoff to 5m).
